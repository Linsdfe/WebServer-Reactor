...
| 🧵 **One Loop Per Thread** | 每个 IO 线程绑定独立 EventLoop，线程间无锁竞争，**实测QPS超9万**，并发性能优异 |
...
| 总处理请求数 | 2925609 |
| 总传输数据量 | 30.11GB |
| **平均QPS (Requests/sec)** | **97225.40** |
| **平均吞吐量 (Transfer/sec)** | **1.00GB** |
| 平均请求延迟 | 2.19ms |
| 最大请求延迟 | 202.90ms |
| 延迟标准差 | 3.97ms |
| 单线程平均每秒请求 | 8.15k |
...
Running 30s test @ http://127.0.0.1:8888/index.html
  ...
  Thread Stats   Avg      Stdev     Max   +/- Stdev
    Latency     2.19ms    3.97ms 202.90ms   96.52%
    Req/Sec     8.15k     0.91k   12.39k    76.45%
  2925609 requests in 30.09s, 30.11GB read
Requests/sec:  97225.40
Transfer/sec:      1.00GB
```
